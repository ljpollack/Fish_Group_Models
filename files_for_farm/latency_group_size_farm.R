...
model_1 <- brm(data = d, family = poisson, 
               ...
               iter = 5000, warmup = 1000, chains = 6, cores = future::availableCores(), 
               control = list(adapt_delta = 0.99, max_treedepth = 15), save_model = "fit_models/stan_model_1")

saveRDS(model_1, "model_1_fit")