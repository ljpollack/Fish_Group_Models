...
model_6 <- brm(data = d, family = hurdle_negbinomial, 
               ...
               control = list(adapt_delta = 0.98, max_treedepth = 15), save_model = "fit_models/stan_model_6")

# save model
saveRDS(model_6, "fit_models/model_6_fit.rds")
