...
model_5 <- brm(data = d, family = hurdle_poisson, 
               ...
               control = list(adapt_delta = 0.98, max_treedepth = 15), save_model = "fit_models/stan_model_5")

# save model
saveRDS(model_5, "fit_models/model_5_fit.rds")
